                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select  class="form-select " id="speaker_id" name="speaker_id">
                                                                ...
                                                                @foreach($languageBySpeakers as $languageBySpeaker)
                                                                    ...
                                                                    <option value="{{$languageBySpeaker->speaker_id}}"  @if ($loop->last) selected @endif >{{$languageBySpeaker->speaker_name}}({{$languageBySpeaker->district_name}})</option>
                                                                @endforeach
                                            ...
                                            @if(count($directedCollections) > 0)
                                                ...
                                                @foreach ($sentenceList as $key=>$sentences)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <a href="{{ url()->current() }}?page={{ ++$key }}" class="nav-link text-dark">
                                                                {{$sentences->sentence}}
                                                            </a>
                                                        </td>
                                            ...
                                            @else
                                                @foreach ($sentenceList as $index => $sentences)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            <a href="{{ url()->current() }}?page={{ ++$index }}" class="nav-link text-dark">
