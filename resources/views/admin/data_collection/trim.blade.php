        ...
        $(document).ready(function() {
            $(".trim").click(function(e){
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    dataType: 'JSON',
                    data: {bangla:bangla,english:english,transcription:transcription,audio_id:audio_id,directed_id:directed_id,spontaneous_id:spontaneous_id,skip_time:skip_time,audio_duration:audio_duration,audio_file:get_audio_base64},
